 ...
 * @version 1.5.0
 * @author mss
 * @url //github.com/Maxiaoxiang
 *
 * @调用方法
 * $(or).pagination(option, callback);
...
(function (factory) {
  ...
  var Pagination = function (element, options) {
    ...
    this.filling = function (index) {
      ...
      html += opts.jump ?
        '<div class="pageJump">' +
        '<span>共' + pageCount + '页，' + opts.totalData + '条数据</span>' +
        '跳转到<input type="text" class="' + opts.jumpIptCls + '">页' +
        '<a href="javascript:;" class="' + opts.jumpBtnCls + '">' + opts.jumpBtn + '</a>' +
        '</div>'
        : '';
      $obj.empty().html(html);
    };
